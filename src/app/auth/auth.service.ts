...
import RefreshTokenResponse from '../models/request-result-models/refresh-token-response';

@Injectable({
  providedIn: 'root'
})
/**
 * Сервис предоставляет доступ к методам авторизации, сброса пароля и т.д.
 */
